...
class Assignment:
	...
	model_xgb = lgb.LGBMRegressor(num_leaves=20, feature_fraction= 0.9, max_depth=-1, learning_rate=0.01, n_estimators=1500)

	# XGBRegressor(objective = 'multi:softprob', colsample_bytree = 0.9, max_depth=3, alpha=10, n_estimators=100, learning_rate=.1, num_class=3)
